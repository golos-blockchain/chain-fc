...
namespace fc {
    namespace rpc {
        ...
        variant http_api_connection::send_call(api_id_type api_id, std::string method_name,
            ...
            try {
                ...
                if (var_obj.contains("method")) {
                    ...
                    try {
                        ...
                        resp_body = fc::json::to_string(
                                fc::rpc::response(*call.id, error_object{1, e.to_detail_string(), fc::variant(e)}));
