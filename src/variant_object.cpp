...
namespace fc {
    ...
    variant_object::variant_object(std::string key, variant val) : _key_value(
    ...
    mutable_variant_object::mutable_variant_object(std::string key, variant val) : _key_value(
