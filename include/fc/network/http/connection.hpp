...
namespace fc {
    ...
    namespace http {
        ...
        struct header {
            header(fc::string k, fc::string v) : key(fc::move(k)), val(fc::move(v)) {
            }
        ...
        public:
            ...
            http::reply request(const fc::string &method, const fc::string &url, const fc::string &body = std::string(),
